...
var floatingFirstNumber = parseFloat(firstNumber);
var secondNumber = prompt('enter another number');
var floatingSecondNumber = parseFloat(secondNumber);
...
var message = '<h1> Math with the numbers ' + floatingFirstNumber + ' and ' + floatingSecondNumber + '</h1>';
...
//    "3 + 4 = 7"
var sum = floatingFirstNumber + floatingSecondNumber;
var multiply = floatingFirstNumber * floatingSecondNumber;
var divide = floatingFirstNumber / floatingSecondNumber;
var subtract = floatingFirstNumber - floatingSecondNumber;

message += '<br><br>' + floatingFirstNumber + ' + ' + floatingSecondNumber + ' = ' + (floatingFirstNumber + floatingSecondNumber);
message += '<br><br>' + floatingFirstNumber + ' * ' + floatingSecondNumber + ' = ' + multiply;
message += '<br><br>' + floatingFirstNumber + ' / ' + floatingSecondNumber + ' = ' + divide;
message += '<br><br>' + floatingFirstNumber + ' - ' + floatingSecondNumber + ' = ' + subtract;
